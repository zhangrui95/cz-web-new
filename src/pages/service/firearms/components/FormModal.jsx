                ...
                if (values) {
                    ...
                    formData = {
                        equipment_message: {
                            ...
                            maintenance_contact_telephone:
                                fieldsValue.maintenance_contact_telephone,
                        ...
                        equipment_type_name: equipmentType.find(
                            v => fieldsValue.equipment_type == v.code,
                        ).name,
                        remark: fieldsValue.remark,
                        vehicle_id: fieldsValue.vehicle_id ? fieldsValue.vehicle_id : '',

                        equipment_organization_name: list.find(
                            v => fieldsValue.equipment_organization_code == v.code,
                        ).name,
                    ...
                    <Col span={12}>
                        <FormItem {...formItemLayout} label="装备日期">
                            {getFieldDecorator('equipment_date', {
                                initialValue: values
                                    ? values.equipment_date == ''
                                        ? ''
                                        : moment(values.equipment_date, ['YYYY-MM-DD'])
                                    : '',
                    ...
                    <Col span={12}>
                        <FormItem {...formItemLayout} label="配发日期">
                            {getFieldDecorator('allotment_date', {
                                initialValue: values
                                    ? values.allotment_date == ''
                                        ? ''
                                        : moment(values.allotment_date, ['YYYY-MM-DD'])
                                    : '',
                            })(<DatePicker style={{ width: '230px' }} disabled={edit} />)}
                        </FormItem>
                    </Col>
