...
const Model = {
	...
	effects: {
        ...
        *getDjj({ payload, success }, { call, put }) {
            const response = yield call(getDjj, payload)
            if (response && success) {
                success(response);
            }
        },
        *saveFirearms({ payload, success }, { call, put }) {
            const response = yield call(saveFirearms, payload)
            if (response && success) {
                success(response);
            }
        },
        *getZfjly({ payload, success }, { call, put }) {
            const response = yield call(getZfjly, payload)
            if (response && success) {
                success(response);
            }
        },
        *getSchedulList({ payload, success }, { call, put }) {
            const response = yield call(getSchedulList, payload)
            if (response && success) {
                success(response);
            }else{
                success();
        ...
        *getFirearmsList({ payload, success }, { call, put }) {
            const response = yield call(getFirearmsList, payload)
            if (response && success) {
                success(response);
            }else{
                success();
        ...
        *getRecommendNavigation({ payload, success }, { call, put }) {
            const response = yield call(getRecommendNavigation, payload)
            if (response && success) {
                success(response)
            }
        },
