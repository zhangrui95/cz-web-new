...
export async function getUseDept(params) {
    const { ...restParams } = params;
    return request(
        `${configUrl.securityCenterUrl}/lowcase/getMechanismTreeByUnitcodeAndDepartment`,
        {
            method: 'POST',
            data: { ...restParams },
        },
...
export async function getDjj(params) {
    const { ...restParams } = params;
    return request(`${configUrl.serverUrl}/duty/getDjj`, {
        method: 'POST',
        data: { ...restParams },
    });
}
export async function getFirearmsList(params) {
    const { ...restParams } = params;
    return request(`${configUrl.serverUrl}/duty/getFirearmsPgListPage`, {
        method: 'POST',
        data: { ...restParams },
    });
}
export async function saveFirearms(params) {
    const { ...restParams } = params;
    return request(`${configUrl.serverUrl}/duty/saveFirearms`, {
        method: 'POST',
        data: { ...restParams },
    });
}
export async function getZfjly(params) {
    const { ...restParams } = params;
    return request(`${configUrl.serverUrl}/duty/getZfjly`, {
        method: 'POST',
        data: { ...restParams },
    });
}
export async function getSchedulList(params) {
    const { ...restParams } = params;
    return request(`${configUrl.serverUrl}/duty/getSchedulList`, {
        method: 'POST',
        data: { ...restParams },
    });
}
...
export async function getRecommendNavigation(params) {
    const { ...restParams } = params;
    return request(`${configUrl.serverUrl}/hull/getRecommendNavigation`, {
        method: 'POST',
        data: { ...restParams },
    });
}
...
export async function insertGpsLabel(params) {
    const { ...restParams } = params;
    return request(`${configUrl.serverUrl}/gps/insertGpsLabel`, {
        method: 'POST',
        data: { ...restParams },
    });
}
...
export async function delGpsLabel(params) {
    const { ...restParams } = params;
    return request(`${configUrl.serverUrl}/gps/delGpsLabel`, {
        method: 'POST',
        data: { ...restParams },
    });
}
