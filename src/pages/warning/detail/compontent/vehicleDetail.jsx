...
<div style={{paddingTop: '12px'}}>
                    ...
                    <div  style={{borderTop: files.comparison_img_qriginal ? '1px solid #1f274c' : '0px'}}>
                        <Row>
                            <Col span={12}>
                                <div className={styles.basicInfor}>
                                    ...
                                    <div className={styles.basicInforColumn} style={{height:files.comparison_img_qriginal ? '385px' : '500px'}}>
                                        <ul>
                                        {
