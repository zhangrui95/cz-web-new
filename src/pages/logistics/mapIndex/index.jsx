            ...
            if (files.length) {
                ...
                if (markOptions.data && markOptions.data.length > 0) {
                    ...
                    if (Source) {
                        ...
                        Source.setData(jsonData);
                        HMap.map.setLayoutProperty(type, 'visibility', 'visible');
                        if(markOptions.data.length == 1){
                            HGis.setMapCenter(HMap, jsonData.features[0].properties.layer.gps);
                        }
                    } else {
