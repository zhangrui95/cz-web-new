...
class logistics extends Component {
    ...
    render() {
        ...
        let wlnum = 0, qynum = 0, yywd = 0
        labeltolabel.map((item)=>{
            if(item.wlkdlx == '企业'){
                qynum = item.count
            }
            else if(item.wlkdlx == '物流公司'){
                wlnum = item.count
            }
            ...
            <div>
                <div className={styles.content_right} style={{paddingLeft:jg&&jg.substring(4)=='00000000'?244:0}}>
                        <ul className={styles.content_right_ul}>
                            <li className={classlabel==''?styles.chooseLabellogis:''} onClick={()=>this.chooselogis('')}>全部({wlnum+qynum+yywd}家)</li>
                            <li className={classlabel=='物流公司'?styles.chooseLabellogis:''} onClick={()=>this.chooselogis('物流公司')}>物流公司（{wlnum}家）</li>
                            <li className={classlabel=='企业'?styles.chooseLabellogis:''} onClick={()=>this.chooselogis('企业')}>企业（{qynum}家）</li>
                            <li className={classlabel=='营业网点'?styles.chooseLabellogis:''} onClick={()=>this.chooselogis('营业网点')}>营业网点（{yywd}家）</li>
                        </ul>
