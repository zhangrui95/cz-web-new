...
class warningList extends React.Component {
    ...
    getDk = record => {
        this.props.warningDk(record);
    };
    render() {
        const { otherIndex, alarmList } = this.props;
        const { tagDropDown } = this.state;
        let list = alarmList && alarmList.length > 0 ? alarmList.slice(0, 50) : [];
        // 0人员异常 1车辆异常 2警情  4人流密度 5重点人员  7巡逻异常 10枪支异常   预警的 类型int
        // list.push({alarm_type:'10',firearms_no:'F176853',alarm_message:{warnInfo:'枪支超出巡逻范围',address:'预警地点XXXXXX路'},alarm_time:'2020-12-25 13:51:16'})
        return (
                ...
                {list && list.length ? (
                    <div className={styles.content}>
                        <div className={styles.list}>
                            {list.map(v => (
                                <div
                                    className={v.alarm_type != 1 ? styles.item : styles.none}
                                    key={v.alarm_id}
                                >
                                    <Button
                                        type="primary"
                                        className={v.jd && v.wd ? styles.dkBtn : styles.none}
                                        onClick={() => this.getDk(v)}
                                    >
                                        堵控
                                    </Button>
                                    {v.alarm_message ? (
                                        <div onClick={() => this.toDetail(v)}>
                                            ...
                                            {v.alarm_type == 1 ? (
                                                ...
                                                >
                                                    {v.alarm_message.comparison_img ? (
                                                        <div className={styles.head}>
                                                            <img
                                                                src={v.alarm_message.comparison_img}
                                                                alt=""
                                                            />
                                                        </div>
                                                    ) : (
                                            ...
                                            <div className={styles.infor}>
                                                            ...
                                                            title={
                                                                ...
                                                                v.alarm_type == 5
                                                                    ? v.alarm_message
                                                                      ...
                                                                      v.alarm_message
                                                                          .verificationPortraitDataList[0]
                                                                          .name
                                                                    : v.alarm_type == 1
                                                                    ? v.alarm_message
                                                                          .verificationPd &&
                                                ...
                                                {v.alarm_type == 4 ? (
                                                    <div className={styles.wasTraffic}>
                                                        人流量 ：
                                                        <span>{v.alarm_message.flow_density}</span>
                                                        人
                                                    </div>
                                                ) : null}
                                                {(v.alarm_type == 0 &&
                                                ...
                                                v.alarm_type == 1 ? (
                                                    <div className={styles.tags}>
                                                        {v.alarm_message.tagesInfoList &&
                                                            v.alarm_message.tagesInfoList.map(
                                                                (item, index) => {
                                                                    if (index <= 2) {
                                                                        return (
                                                                            <span
                                                ...
                                                {v.alarm_type == 7 ? (
                                                    <div className={styles.address}>巡逻异常</div>
                                                ) : null}
                                                {v.alarm_type == 10 ? (
