...
import styles from './snapPeDetail.less';
                ...
                {files && (
                    <div>
                        {files.verificationPortraitDataList && (
                            <div>
                                <div style={{ paddingTop: '12px',float:'left',width:'20%' }}>
                                    <Row>
                                        <Col span={18}>
                                            <Row gutter={16}>
                                                ...
                                                {/*    ?*/}
                                                {/*    <Col className="gutter-row" span={2} style={{paddingLeft: '20px'}}>*/}
                                                {/*        <div className="gutter-box" className={styles.gutterBox}>*/}
                                            ...
                                            <div className={styles.basicInfor}>
                                                <div>
                                                    <Row>
                                                        ...
                                                        {/*{*/}
                                                        {/*    files.verificationPortraitDataList.length && files.verificationPortraitDataList[itemId].comparisonData.basicInformation[basicId].data[0]&&files.verificationPortraitDataList[itemId].comparisonData.basicInformation[basicId].data[0].XP*/}
                                                        {/*    ?*/}
