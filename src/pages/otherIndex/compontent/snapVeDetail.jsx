                    ...
                    <div>
                        ...
                        <div style={{ borderTop: '1px solid #1f274c' }}>
                            <Row>
                                ...
                                {/*                    }*/}
                                {/*                    </Button.Group>*/}
                                {/*                    <div className={styles.abnormalInforTitle}>{files.tagesInfoList&&files.tagesInfoList[abnormalId].name ? files.tagesInfoList[abnormalId].name : '异常车辆'}</div>*/}
                                {/*                </Col>*/}
