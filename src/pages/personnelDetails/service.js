...
export async function getPersonRelation(params) {
    const { ...restParams } = params;
    return request(`${configUrl.serverUrl}/person/getPersonRelation`, {
        method: 'POST',
        data: { ...restParams },
    });
}
export async function getPersonHotelList(params) {
    const { ...restParams } = params;
    return request(`${configUrl.serverUrl}/person/getPersonHotelList`, {
        method: 'POST',
        data: { ...restParams },
    });
}
export async function getPersonHotelDetail(params) {
    const { ...restParams } = params;
    return request(`${configUrl.serverUrl}/person/getPersonHotelDetail`, {
        method: 'POST',
        data: { ...restParams },
    });
}
